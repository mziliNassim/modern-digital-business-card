...
import TopMessageAlert from "./TopMessageAlert";

// Mock logo for demo
const appLogo = "/logo/dbc.png";
...
const NavBar = () => {
  ...
  const navLinks = [
    ...
    { name: "AboutUs", path: "/company/about-us" },
    { name: "Blog", path: "/company/blog" },
    { name: "Support", path: "/company/support" },
  ];
            ...
            <div className="flex items-center space-x-4">
              ...
              {user ? (
                ...
                >
                  <Link
                    to="/auth/signin"
                    className="relative cursor-pointer px-6 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-[#f35a57] to-[#d94744] rounded-xl shadow-md hover:shadow-lg transition-all duration-200 overflow-hidden group"
                  >
